...
public class JdbcKnowledgeBase extends KnowledgeBase {
    ...
    private class JdbcOperatorFactory extends OperatorFactory {
        ...
        private final String ID = PROPS.getProperty("ariadne.operators.id");
        private final String CLASS_NAME = PROPS.getProperty("ariadne.operators.class_name");
        private final String DESCR = PROPS.getProperty("ariadne.operators.desc");
        private final String TABLE = PROPS.getProperty("ariadne.operators.table");
    ...
    private class JdbcOperandOwnerFactory extends OperandOwnerFactory {
        private final String TABLE = PROPS.getProperty("ariadne.operand_owners.table");

        private final String OO_CLASS_NAME = PROPS.getProperty("ariadne.operand_owners.class_name");
        private final String INPUT = PROPS.getProperty("ariadne.operand_owners.input");
        private final String OWNER_ID = PROPS.getProperty("ariadne.operand_owners.id");
        private DBDataLoader dbtool = new DBDataLoader(connection, TABLE);
    ...
    private class JdbcOperationFactory extends OperationFactory {
        private final String TABLE = PROPS.getProperty("ariadne.operations.table");

        private final String PID = PROPS.getProperty("ariadne.operations.id");
        private final String LHO_ID = PROPS.getProperty("ariadne.operations.lho");
        private final String OP_ID = PROPS.getProperty("ariadne.operations.op");
        private final String RHO_ID = PROPS.getProperty("ariadne.operations.rho");
        private final String DESC = PROPS.getProperty("ariadne.operations.desc");
        ...
        public JdbcOperationFactory() {
            super(JdbcKnowledgeBase.this);
            String temp = PROPS.getProperty("ariadne.operations.desc.max.length");
